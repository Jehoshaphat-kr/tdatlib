...
class interface_stock(fetch_stock):
    ...
    def backtest_return(self) -> pd.DataFrame:
        ...
        :return:
                     ...
                     시가    고가  저가   종가  등락  MAX20TD  MIN20TD
        날짜
        2021-05-03  25950  26150  25500  25900  0.00    20.42    -1.73
        2021-05-04  25950  26600  25950  26500  2.32    20.42    -1.73
        2021-05-06  26500  27250  26500  27200  2.64    20.42    -1.73
               ...    ...    ...    ...    ...   ...      ...      ...
        2021-05-28  29650  29950  29200  29550 -0.17    20.42    -1.73
        2021-05-31  29550  30200  29300  29900  1.18    20.42    -1.73
        2021-06-01  30050  30400  29500  29500 -1.34    20.42    -1.73
        """
